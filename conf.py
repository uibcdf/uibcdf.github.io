...
BLOG_AUTHOR = "Liliana M. Moreno-Vargas & Diego Prada-Gracia"  # (translatable)
...
FAVICONS = (
     ("icon", "/images/favicon_16x16.png", "16x16"),
...
CONTENT_FOOTER = 'Contents &copy; {date} <a href="members">Liliana M. Moreno-Vargas</a> & <a href="members">Diego Prada-Gracia</a> at the <a href="http://himfg.com.mx/">Mexico City Children\'s Hospital "Federico Gómez"</a> | Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>       {license}'
...
TWITTER_CARD = {
    ...
    'site': '@uibcdf',         # twitter nick for the website
    'creator': '@uibcdf',     # Username for the content creator / author.
}
